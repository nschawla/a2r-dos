...
| FR-TEN-6 | Delivery modules: Commercial Baseline (sizing + rate card), Controls Audit (CTRL_01–10 weighted scoring), RAID, Financial Realization (EAC / BAC / margin drift), Schedule & Milestones, Executive Briefing Hub, SteerCo Briefing, Capacity & Concurrency cockpit, Custom KPI engine, 4-pillar Batch Import. |
